...
public class Chessboard {
    ...
    public void setBoard() {
        ...
        board[7][0] = new Pawn("BP1", false, "a8");
        board[7][1] = new Pawn("BP2", false, "b8");
        board[7][2] = new Pawn("BP3", false, "c8");
        board[7][3] = new Pawn("BP4", false, "d8");
        board[7][4] = new Pawn("BP5", false, "e8");
        board[7][5] = new Pawn("BP6", false, "f8");
        board[7][6] = new Pawn("BP7", false, "g8");
        board[7][7] = new Pawn("BP8", false, "h8");
    }
